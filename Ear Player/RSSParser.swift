    ...
    */
    func parser(parser: NSXMLParser, didEndElement elementName: String, namespaceURI: String?, qualifiedName qName: String?) {
        ...
        if let item = self.currentItem
        {
            ...
            {
                item.setLinkk(self.currentElement)
            }
            ...
            {
                item.setPubDatee(self.currentElement)
            }
            ...
            {
                item.setCommentsLinkk(self.currentElement)
            }
            ...
            {
                item.setCommentRSSLinkk(self.currentElement)
            }
        ...
        else
        {
            ...
            if elementName == node_link
            {
                feed.setLinkk(self.currentElement)
            }
