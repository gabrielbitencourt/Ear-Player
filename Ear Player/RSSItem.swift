...
class RSSItem: NSObject, NSCoding {
    ...
    func setLinkk(let linkString: String!)
    {
    ...
    func setPubDatee(let dateString: String!)
    {
    ...
    func setCommentsLinkk(let linkString: String!)
    {
    ...
    func setCommentRSSLinkk(let linkString: String!)
    {
